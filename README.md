...
3. Go to your forked repo Settings > Secrets and add secrets for:
  ...
  * ADMIN_TOKEN (enter a strong, random string. you will need this string to enter admin settings by going to HEROKU_APP_NAME.herokuapp.com/admin) [Value alphanumerical]
